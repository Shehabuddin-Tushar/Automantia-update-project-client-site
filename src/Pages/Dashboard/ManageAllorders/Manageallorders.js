...
function Manageallorders() {
  ...
  useEffect(() => {
    ...
    axios.get(`https://warm-depths-72297.herokuapp.com/allorders`).then(res => setAllordersdata(res.data)).catch(err => console.log(err))
  ...
  const changestatus = (id) => {
    ...
    if (confirmchange) {
      ...
      axios.put(`https://warm-depths-72297.herokuapp.com/changestatus/${id}`).then(res => {
