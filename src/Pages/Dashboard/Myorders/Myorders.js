...
function Myorders() {
  ...
  useEffect(() => {
    ...
    axios.get(`https://automantia-serverside.onrender.com/myorders?email=${user.email}`)
      .then(res => {
  ...
  const deleteorder = (id) => {
    ...
    if (confirmdelete) {
      ...
      axios.delete(`https://automantia-serverside.onrender.com/deleteorder/${id}`).then(res => {
        console.log(res)
