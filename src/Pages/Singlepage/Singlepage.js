...
function Singlepage() {
  ...
  const onSubmit = data => {
    ...
    axios.post(`https://automantia-serverside.onrender.com/ordersave`, data)
      .then(res => {
  ...
  useEffect(() => {
    axios.get(`https://automantia-serverside.onrender.com/product/${id}`).then(res => setProduct(res.data)).catch(err => console.log(err));
  }, [])
  return (
